...
#define BABYSTEPPING
  ...
  #define BABYSTEP_MULTIPLICATOR 2  // Babysteps are very small. Increase for faster motion. Originalmente el valor era 5
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define PAUSE_PARK_Z_ADD 0                  // Z addition of hotend (lift). //Puede probarse a añadir offset y ver si no hay desplazamiento de capas. Si da problemas, debe ponerse 0
  #define PAUSE_PARK_XY_FEEDRATE 20          // X and Y axes feedrate in mm/s (also used for delta printers Z axis)
  #define PAUSE_PARK_Z_FEEDRATE 3             // Z axis feedrate in mm/s (not used for delta printers)
  #define PAUSE_PARK_RETRACT_FEEDRATE 6      // Initial retract feedrate in mm/s
  #define PAUSE_PARK_RETRACT_LENGTH 2         // Initial retract in mm
                                              // It is a short retract used immediately after print interrupt before move to filament exchange position
  #define FILAMENT_CHANGE_UNLOAD_FEEDRATE 6  // Unload filament feedrate in mm/s - filament unloading can be fast
  ...
  #define FILAMENT_CHANGE_LOAD_LENGTH 160       // Load filament length over hotend in mm
  ...
  #define PARK_HEAD_ON_PAUSE                // Go to filament change position on pause, return to print position on resume. Función extra añadida.
